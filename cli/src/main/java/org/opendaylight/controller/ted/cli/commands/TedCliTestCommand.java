 ...
 */
package org.opendaylight.controller.ted.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.opendaylight.controller.ted.cli.api.TedCliCommands;
...
public class TedCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TedCliTestCommand.class);
    protected final TedCliCommands service;

    public TedCliTestCommand(final TedCliCommands service) {
